...
public enum ErrorCode {
	...
	SELLER_APPROVAL_PENDING(HttpStatus.FORBIDDEN, "SELLER_APPROVAL_PENDING", "판매자 승인 대기 중"),
	SELLER_APPROVAL_REJECTED(HttpStatus.FORBIDDEN, "SELLER_APPROVAL_REJECTED", "판매자 승인 거부"),
	SELLER_SUSPENDED(HttpStatus.FORBIDDEN, "SELLER_SUSPENDED", "판매자 이용 정지"),
